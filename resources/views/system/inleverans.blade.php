...
<div ng-app="MyApp">
<div id="page-wrapper" ng-controller="itemController" ng-init="uid('{{ Auth::user()->id }}')">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row" >
                ...
                <div class="col-xs-6 wborder" ng-init="tab = 7">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Produkter    
                        </div>
                        <!-- /.panel-heading -->
                ...
                <div class="col-xs-6 wborder">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-long-arrow-right fa-fw"> </i> Transaktion
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="row">
                        ...
                        <li ng-class="{ active: tab === 6 }" ng-click="tab = 6; Osort = {type: 'torr'}" class="btn btn-default">Torr varor</li>
                             ...
                             <div class="row">
                                    <div class="col-lg-12">
                                            ...
                                            <table class="table table-bordered table-hover table-striped dataTable5">
                                                <thead>
                                                    <tr>
                                                        <th>Art.Nr</th>
                                                        <th>Namn</th>
